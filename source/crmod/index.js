...
async function main() {
    ...
    try {
        ...
        '# cfslang util to create modules', { encoding: 'utf-8' })

        console.clear();
        print_progress(desc, 75);

        writeFileSync(join(process.cwd(), modName, 'main.cfs'), '# This is your new module. You can now modify this file!', { encoding: 'utf-8' })
